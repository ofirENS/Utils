/*
 * BendingElasticity_emxutil.h
 *
 * Code generation for function 'BendingElasticity_emxutil'
 *
 */

#ifndef __BENDINGELASTICITY_EMXUTIL_H__
#define __BENDINGELASTICITY_EMXUTIL_H__
...
/* End of code generation (BendingElasticity_emxutil.h) */
