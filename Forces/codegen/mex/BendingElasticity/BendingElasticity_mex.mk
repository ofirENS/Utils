...
MAKEFILE = BendingElasticity_mex.mk

include BendingElasticity_mex.mki


SRC_FILES =  \
	BendingElasticity_data.c \
	...
	BendingElasticity_emxutil.c \
	_coder_BendingElasticity_mex.c \
	_coder_BendingElasticity_info.c

MEX_FILE_NAME_WO_EXT = BendingElasticity_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/BendingElasticity"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/BendingElasticity/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BendingElasticity/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BendingElasticity/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/BendingElasticity/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
