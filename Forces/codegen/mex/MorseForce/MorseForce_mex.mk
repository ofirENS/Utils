...
MAKEFILE = MorseForce_mex.mk

include MorseForce_mex.mki
...
SRC_FILES =  \
	...
	MorseForce_emxutil.c \
	_coder_MorseForce_mex.c \
	_coder_MorseForce_info.c

MEX_FILE_NAME_WO_EXT = MorseForce_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/MorseForce"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/MorseForce/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/MorseForce/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/MorseForce/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/MorseForce/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
