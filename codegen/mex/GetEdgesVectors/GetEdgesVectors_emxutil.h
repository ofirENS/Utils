/*
 * GetEdgesVectors_emxutil.h
 *
 * Code generation for function 'GetEdgesVectors_emxutil'
 *
 */

#ifndef __GETEDGESVECTORS_EMXUTIL_H__
#define __GETEDGESVECTORS_EMXUTIL_H__
...
/* End of code generation (GetEdgesVectors_emxutil.h) */
